...
const authConfig = defineConfig({
  providers: [
    Twitch({
      clientId: "po39monbklc33xlg0rwxyuqb5hvxit",
      clientSecret: "9oqfdqo96lrhly9uzpd86sioqmlj3t"
    })
  ]
});
...
function AstroAuth(options = authConfig) {
  const { AUTH_SECRET, AUTH_TRUST_HOST, VERCEL, NODE_ENV } = Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": undefined, "ASSETS_PREFIX": undefined}, { AUTH_SECRET: "e8caec28c35d7a9874ec1cf7656ca54af5e02632287c228c417a00d4738db08b", AUTH_TRUST_HOST: "true", NODE: process.env.NODE, NODE_ENV: process.env.NODE_ENV });
...
async function getSession(req, options = authConfig) {
  options.secret ??= "e8caec28c35d7a9874ec1cf7656ca54af5e02632287c228c417a00d4738db08b";
